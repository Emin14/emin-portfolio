...
import {
  faTelegram, faGithub, faLinkedinIn, faWhatsapp,
...
export const socialIcons = [
  { title: 'Telegram', icon: faTelegram, link: 'https://t.me/emin_az14' },
  { title: 'GitHub', icon: faGithub, link: 'https://github.com/Emin14?tab=repositories' },
  { title: 'LinkedIn', icon: faLinkedinIn, link: 'https://www.linkedin.com/in/emin-agjaev/' },
  { title: 'WhatsApp', icon: faWhatsapp, link: 'https://api.whatsapp.com/send?phone=79537375512' },
  { title: 'Email', icon: faEnvelope, link: 'mailto:emin-agjaev@mail.ru' },
];
